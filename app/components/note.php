...
function note($note)
{
  ...
  if ($note['collaborator_id'] != NULL) {
    ...
    if ($note_owner['id'] == $_SESSION['user_id']) {
    ...
    case 'NOT_COLLABORATOR':
      return "
        ...
        "<p class='created-at'>" . htmlspecialchars($note['created_at']) . "</p>
          ...
          <div class='note-menu'>
            <a href='home.php?update_note=" . urlencode($note['id']) . "'>Edit</a>
            ...
            <a class='delete' href='" . BASE_URL . "/note/delete/" . $note['id'] . "'>Delete</a>
          </div>
        </div>";
    ...
    case 'COLLABORATOR':
      return "
        ...
        "<p class='created-at'>" . htmlspecialchars($note['created_at']) . "</p>
          ...
          <div class='note-menu'>
            <a class='update' href='home.php?update_note=" . urlencode($note['id']) . "'>Edit</a>
