  ...
  return '
    <header id="nav">
      <div class="vertical">
        ...
        <nav>
          <a href="' . BASE_URL . '/home" class="' . ($active == 'home' ? 'nav-active' : '') . '"><p>Home</p> ' . $svg['home'] . ' </a>

          <a href="' . BASE_URL . '/trash" class="' . ($active == 'trash' ? 'nav-active' : '') . '"><p>Trash</p> ' . $svg['trash'] . '</a>
        </nav>
      
        <a href="' . BASE_URL . '/auth/logout" class="logout"><p>Logout</p> ' . $svg['logout'] . '</a>
      </div>
